...
public class ifStatement02 {
    public static void main(String[] args) {
        ...
        //BVA tekniği: Boundry Value Analysis tekniğidir, sınırları kritik değerleri test etmek yani. Bu örnekte;
        // 1 ve 7 arası haricinde pozitiflerden negatiflerden ve nörtden bir tane test edip kodu deniyorsun.
