...
/*
    Sabit ve değişmezler enum'dır ve büyük harflerle yazılmalıdır. Yanına parantez açarak detaylandırabiliriz.
    Enum'da new keywordü ile yeni obje oluşturamayız. İçindeki her bir data zaten enumdan oluşturulmuş bir objeymiş gibi çalışır.
    Bu yüzden ismi. ile de oluşturabiliriz.
    Enum içindeki constructorları enumları başlatmak için kullanırız. Generate ile anında yapılır.
     */

    /*
    1) Enumdaki datalar sabittir.
    2) Enumda new keywordü ile yeni bir obje oluşturamayız.
    3) Çünkü Enum içine koymuş olduğumuz her bir sabit data,bu classtan oluşturulmuş bir obje mantığı ile çalışır.
    4) Enum içerisinde koymuş olduğumuz her bir sabit, default olarak public static ve final olarak tanımlanmıştır.
    5) Bu nedenle Enum içerisindeki her bir sabit dahata Enum ismi ve nokta koyarak ulaşabiliriz.
    6) Enumdaki constructor ynei bir object oluşturmak için değil, Enum'ın içindeki her bir sabit datanın içindeki variablları
    başlatmak için kullanılır.
    7) Private sabit dataları görebilmek için Getter oluşturabiliriz.
     */
